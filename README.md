...
*   **`src/`**: Contains the source code.
    ...
    *   `java/time`: Stub implementation of Java Time API (Duration) to simplify JBMC verification.
    *   `org/cprover`: JBMC specific helper classes (CProver.java).
...
1.  **No Illegal Transitions**:         ~~(Implemented)
...
1.  **Failure Threshold Logic**:    ~~(Implemented)
